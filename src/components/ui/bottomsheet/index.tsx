...
const bottomSheetIndicatorStyle = tva({
  base: 'py-1 w-full items-center rounded-t-md ',
});

const bottomSheetItemStyle = tva({
  base: 'p-3 flex-row items-center rounded-none w-full disabled:opacity-0.4 web:pointer-events-auto disabled:cursor-not-allowed hover:bg-surface-raised active:bg-surface-subtle focus:bg-surface-subtle web:focus-visible:bg-surface-subtle',
});
